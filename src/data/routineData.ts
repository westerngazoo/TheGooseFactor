...
const SCIENTIFIC_ADDITIONS: FlatExercise[] = [
  ...
  // ── Rotator cuff & shoulder isolation (EMG-validated) ──
  {name: 'Side-Lying External Rotation', category: 'isolation', primary: ['shoulder'], sets: '3', reps: '12-15/side', notes: 'Lie on your side, elbow pinned to the ribs, rotate a light DB up. EMG research (Reinold et al.) ranks this among the highest infraspinatus and teres minor activators — the rotator-cuff staple.', primarySub: ['delt_rear'], phases: ['warmup', 'pump'], equipment: ['dumbbell']},
  {name: 'Full Can Raise', category: 'isolation', primary: ['shoulder'], sets: '3', reps: '12-15', notes: 'Raise DBs in the scapular plane, thumbs up. The "full can" matches empty-can supraspinatus activation with far less impingement — preferred in cuff rehab.', primarySub: ['delt_side'], phases: ['warmup', 'pump'], equipment: ['dumbbell']},
  {name: 'Scaption Raise', category: 'isolation', primary: ['shoulder'], sets: '3', reps: '12-15', notes: 'Raise DBs ~30° forward of the side — the scapular plane. Loads the supraspinatus and delts where the shoulder joint is most congruent.', primarySub: ['delt_side', 'delt_front'], phases: ['warmup', 'pump'], equipment: ['dumbbell']},
  {name: 'Prone Horizontal Abduction (T)', category: 'isolation', primary: ['shoulder'], secondary: ['back', 'traps'], sets: '3', reps: '12-15', notes: 'Face-down on a bench, raise light DBs out to a "T". EMG-validated for the posterior cuff plus mid/lower trap — a Kibler scapular-health staple.', primarySub: ['delt_rear'], secondarySub: ['traps_mid', 'rhomboids'], phases: ['warmup', 'pump'], equipment: ['dumbbell']},
  {name: '90/90 Cable External Rotation', category: 'isolation', primary: ['shoulder'], sets: '3', reps: '12-15/side', notes: 'Arm abducted 90°, elbow bent 90°, rotate the forearm up against the cable. Trains the cuff in the functional throwing position.', primarySub: ['delt_rear'], phases: ['warmup', 'pump'], equipment: ['cable']},
  {name: 'Prone External Rotation', category: 'isolation', primary: ['shoulder'], secondary: ['traps'], sets: '3', reps: '12-15/side', notes: 'Face-down, upper arm on the bench at 90°, rotate a light DB up. Blackburn-style posterior-cuff and scapular-stabiliser work.', primarySub: ['delt_rear'], phases: ['warmup', 'pump'], equipment: ['dumbbell']},
  {name: 'Lean-Away Cable Lateral Raise', category: 'isolation', primary: ['shoulder'], sets: '3', reps: '12-15/side', notes: 'Hold an upright, lean away from a low cable. Keeps tension on the side delt at its lengthened position — favourable for stretch-mediated growth.', primarySub: ['delt_side'], phases: ['medium', 'pump'], equipment: ['cable']},
  {name: 'Cross-Body Cable Rear Delt Fly', category: 'isolation', primary: ['shoulder'], sets: '3', reps: '12-15/side', notes: 'Single low cable swept across the body. Isolates the rear delt with constant tension and minimal mid-trap takeover.', primarySub: ['delt_rear'], phases: ['medium', 'pump'], equipment: ['cable']},

  // ── Cervical / neck (research-backed rehab) ──
  {name: 'Craniocervical Flexion', category: 'isolation', primary: ['neck'], sets: '3', reps: '10 × 10s holds', notes: 'Supine, gently nod the head (chin to throat) without lifting it — a subtle "yes". Targets the deep cervical flexors; Jull/Falla research backs it for neck pain and cervicogenic headache.', phases: ['warmup'], equipment: ['bodyweight']},
  {name: 'Prone Cervical Extension Hold', category: 'isolation', primary: ['neck'], secondary: ['traps'], sets: '3', reps: '20-40s', notes: 'Face-down, head off the bench edge, hold the neck level. Builds cervical-extensor endurance — a neck-pain rehab staple.', phases: ['warmup', 'medium'], equipment: ['bodyweight']},
  {name: 'Supine Neck Flexor Endurance Hold', category: 'isolation', primary: ['neck'], sets: '3', reps: '20-40s', notes: 'Lie face-up, tuck the chin and hold the head just off the floor. The deep-neck-flexor endurance test turned into a drill — low endurance here is a documented neck-pain risk factor.', phases: ['warmup', 'medium'], equipment: ['bodyweight']},
  {name: 'Banded Cervical Rotation', category: 'isolation', primary: ['neck'], sets: '3', reps: '12-15/side', notes: 'Band anchored to the side of the head; rotate the chin toward the shoulder against resistance. Trains the rotational plane the plate exercises miss.', phases: ['warmup', 'pump'], equipment: ['band']},
];
